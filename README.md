...
Для збирання бібліотеки в GitHub actions використовується ранер `ubuntu-22.04-arm` для компіляції нативно. (Швидкість виконання 2.5-3 хв)<br>
...
***Дисклеймер***<br>
_Хоча тести явно не прописані, деякі все одно відбуваютьсяв в процесі створення .deb за допомогою dpkg на етапі dh_auto_test_<br>
<br>
